            ...
            <div className="container-custom max-w-[1080px]">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-1">
                        <h3 className="text-xl font-bold mb-6 text-white uppercase font-heading tracking-wider">About Banglabet88</h3>
                        ...
                        <div className="text-sm space-y-3">
                            ...
                            <p className="flex items-center gap-2"><Mail size={18} className="text-primary shrink-0" /> support@banglabet88.net</p>
                    ...
                    <div className="md:col-span-1">
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link href="/slots" className="hover:text-primary transition-colors">Slots</Link></li>
                        </ul>
                    </div>
